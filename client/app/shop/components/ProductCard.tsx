...
const ProductCard: React.FC<ProductData> = (props) => {
  ...
  return (
    <div
      className='relative border-gray-300 rounded-lg h-full w-full  max-h-96  '
...
const Actions = ({
  ...
  return (
    <button
      onClick={handleClick}
      className={cn(
        "flex items-center bg-white text-gray-800 rounded-full px-4 py-2 shadow-md hover:bg-gray-100",
        className
      )}
    >
      {children}
